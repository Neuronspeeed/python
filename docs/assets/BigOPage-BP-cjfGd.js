...
# Different Big O? Big O wins (usually).`}],u=[{signature:`Recognizing complexity patterns - cheat sheet`,description:`Halving → log n. One loop → n. Nested loops → n². Recursion → tree depth. Master pattern recognition for instant analysis.`,complexity:`Concept`,section:`Why & When`,example:`# PATTERN RECOGNITION CHEAT SHEET
...
# Practice: Look at code, identify pattern!`}],d=[{signature:`Sorting Algorithm Comparison`,description:`Quick/Merge/Heap sort: O(n log n). Python sorted() uses Timsort - O(n log n) adaptive.`,complexity:`Reference`,section:`Sorting Algorithms`,example:`# SORTING ALGORITHMS COMPARISON
#
...
# - Don't need stability`}],f=[{signature:`Graph Algorithm Complexities`,description:`BFS/DFS: O(V+E). Dijkstra: O((V+E) log V). Floyd-Warshall: O(V³).`,complexity:`Reference`,section:`Graph Algorithms`,example:`# GRAPH ALGORITHM COMPLEXITIES
# V = vertices, E = edges
#
...
# Cycle detection:            DFS
# Topological order:          Kahn's or DFS`}],p=[{signature:`Recognize O(1)`,description:`Hash lookups, array access by index, push/pop stack, arithmetic operations.`,complexity:`O(1)`,section:`Recognize Patterns`,example:`# O(1) CONSTANT TIME OPERATIONS
...
# - Union-Find with path compression`}],m=[...c,...l,...u,...d,...f,...p],h=[...s,...m];var g=t();const _=[{notation:`O(1)`,name:`Constant`,rating:`Excellent`,color:`#16A34A`,calc:()=>1},{notation:`O(log n)`,name:`Logarithmic`,rating:`Good`,color:`#78716C`,calc:e=>Math.log2(e)},{notation:`O(n)`,name:`Linear`,rating:`Fair`,color:`#CA8A04`,calc:e=>e},{notation:`O(n log n)`,name:`Linearithmic`,rating:`Bad`,color:`#EA580C`,calc:e=>e*Math.log2(e)},{notation:`O(n²)`,name:`Quadratic`,rating:`Horrible`,color:`#DC2626`,calc:e=>e*e},{notation:`O(2ⁿ)`,name:`Exponential`,rating:`Horrible`,color:`#9333EA`,calc:e=>2**Math.min(e,20)}],v=[{name:`Array`,avgAccess:`Θ(1)`,avgSearch:`Θ(n)`,avgInsert:`Θ(n)`,avgDelete:`Θ(n)`,worstAccess:`O(1)`,worstSearch:`O(n)`,worstInsert:`O(n)`,worstDelete:`O(n)`,space:`O(n)`},{name:`Stack`,avgAccess:`Θ(n)`,avgSearch:`Θ(n)`,avgInsert:`Θ(1)`,avgDelete:`Θ(1)`,worstAccess:`O(n)`,worstSearch:`O(n)`,worstInsert:`O(1)`,worstDelete:`O(1)`,space:`O(n)`},{name:`Queue`,avgAccess:`Θ(n)`,avgSearch:`Θ(n)`,avgInsert:`Θ(1)`,avgDelete:`Θ(1)`,worstAccess:`O(n)`,worstSearch:`O(n)`,worstInsert:`O(1)`,worstDelete:`O(1)`,space:`O(n)`},{name:`Singly-Linked List`,avgAccess:`Θ(n)`,avgSearch:`Θ(n)`,avgInsert:`Θ(1)`,avgDelete:`Θ(1)`,worstAccess:`O(n)`,worstSearch:`O(n)`,worstInsert:`O(1)`,worstDelete:`O(1)`,space:`O(n)`},{name:`Doubly-Linked List`,avgAccess:`Θ(n)`,avgSearch:`Θ(n)`,avgInsert:`Θ(1)`,avgDelete:`Θ(1)`,worstAccess:`O(n)`,worstSearch:`O(n)`,worstInsert:`O(1)`,worstDelete:`O(1)`,space:`O(n)`},{name:`Skip List`,avgAccess:`Θ(log n)`,avgSearch:`Θ(log n)`,avgInsert:`Θ(log n)`,avgDelete:`Θ(log n)`,worstAccess:`O(n)`,worstSearch:`O(n)`,worstInsert:`O(n)`,worstDelete:`O(n)`,space:`O(n log n)`},{name:`Hash Table`,avgAccess:`N/A`,avgSearch:`Θ(1)`,avgInsert:`Θ(1)`,avgDelete:`Θ(1)`,worstAccess:`N/A`,worstSearch:`O(n)`,worstInsert:`O(n)`,worstDelete:`O(n)`,space:`O(n)`},{name:`Binary Search Tree`,avgAccess:`Θ(log n)`,avgSearch:`Θ(log n)`,avgInsert:`Θ(log n)`,avgDelete:`Θ(log n)`,worstAccess:`O(n)`,worstSearch:`O(n)`,worstInsert:`O(n)`,worstDelete:`O(n)`,space:`O(n)`},{name:`B-Tree`,avgAccess:`Θ(log n)`,avgSearch:`Θ(log n)`,avgInsert:`Θ(log n)`,avgDelete:`Θ(log n)`,worstAccess:`O(log n)`,worstSearch:`O(log n)`,worstInsert:`O(log n)`,worstDelete:`O(log n)`,space:`O(n)`},{name:`Red-Black Tree`,avgAccess:`Θ(log n)`,avgSearch:`Θ(log n)`,avgInsert:`Θ(log n)`,avgDelete:`Θ(log n)`,worstAccess:`O(log n)`,worstSearch:`O(log n)`,worstInsert:`O(log n)`,worstDelete:`O(log n)`,space:`O(n)`},{name:`AVL Tree`,avgAccess:`Θ(log n)`,avgSearch:`Θ(log n)`,avgInsert:`Θ(log n)`,avgDelete:`Θ(log n)`,worstAccess:`O(log n)`,worstSearch:`O(log n)`,worstInsert:`O(log n)`,worstDelete:`O(log n)`,space:`O(n)`}],y=[{name:`Quicksort`,best:`Ω(n log n)`,avg:`Θ(n log n)`,worst:`O(n²)`,space:`O(log n)`},{name:`Mergesort`,best:`Ω(n log n)`,avg:`Θ(n log n)`,worst:`O(n log n)`,space:`O(n)`},{name:`Timsort`,best:`Ω(n)`,avg:`Θ(n log n)`,worst:`O(n log n)`,space:`O(n)`},{name:`Heapsort`,best:`Ω(n log n)`,avg:`Θ(n log n)`,worst:`O(n log n)`,space:`O(1)`},{name:`Bubble Sort`,best:`Ω(n)`,avg:`Θ(n²)`,worst:`O(n²)`,space:`O(1)`},{name:`Insertion Sort`,best:`Ω(n)`,avg:`Θ(n²)`,worst:`O(n²)`,space:`O(1)`},{name:`Selection Sort`,best:`Ω(n²)`,avg:`Θ(n²)`,worst:`O(n²)`,space:`O(1)`},{name:`Tree Sort`,best:`Ω(n log n)`,avg:`Θ(n log n)`,worst:`O(n²)`,space:`O(n)`},{name:`Shell Sort`,best:`Ω(n log n)`,avg:`Θ(n(log n)²)`,worst:`O(n(log n)²)`,space:`O(1)`},{name:`Bucket Sort`,best:`Ω(n+k)`,avg:`Θ(n+k)`,worst:`O(n²)`,space:`O(n)`},{name:`Radix Sort`,best:`Ω(nk)`,avg:`Θ(nk)`,worst:`O(nk)`,space:`O(n+k)`},{name:`Counting Sort`,best:`Ω(n+k)`,avg:`Θ(n+k)`,worst:`O(n+k)`,space:`O(k)`}];function b(e){return e>=1e9?`${(e/1e9).toFixed(1)}B`:e>=1e6?`${(e/1e6).toFixed(1)}M`:e>=1e3?`${(e/1e3).toFixed(1)}K`:Math.round(e).toString()}function x(e){let t=e.toLowerCase().replace(/\s/g,``);return t===`n/a`||t===`-`?`na`:t.includes(`1)`)&&!t.includes(`n`)?`excellent`:t.includes(`logn)`)&&!t.includes(`nlog`)?`good`:t.includes(`n)`)&&!t.includes(`n²`)&&!t.includes(`n^2`)&&!t.includes(`nlog`)&&!t.includes(`nk`)&&!t.includes(`n+k`)?`fair`:t.includes(`nlogn)`)||t.includes(`n+k)`)||t.includes(`nk)`)?`bad`:t.includes(`n²`)||t.includes(`n^2`)||t.includes(`(n(log`)?`horrible`:`fair`}var S=n();function C(){let e=(0,g.useRef)(null),t=(0,g.useRef)(null),n=(0,g.useRef)(null),r=(0,g.useRef)(null),[i,a]=(0,g.useState)(25),[o,s]=(0,g.useState)(new Set(_.map(e=>e.notation))),[c,l]=(0,g.useState)(null),[u,d]=(0,g.useState)({visible:!1,x:0,y:0,content:[],n:0}),[f,p]=(0,g.useState)(!1),[m,h]=(0,g.useState)(null),v=(0,g.useCallback)(()=>{let t=e.current;if(!t)return;let n=t.getContext(`2d`);if(!n)return;let r=window.devicePixelRatio||1,a=t.getBoundingClientRect();t.width=a.width*r,t.height=a.height*r,n.scale(r,r);let s=a.width,l=a.height,u={top:30,right:70,bottom:40,left:55},d=s-u.left-u.right,f=l-u.top-u.bottom;n.fillStyle=`var(--bg-card)`,n.fillRect(0,0,s,l);let p=getComputedStyle(document.documentElement),m=p.getPropertyValue(`--bg-card`).trim()||`#EFEBE4`,h=p.getPropertyValue(`--border-color`).trim()||`rgba(0,0,0,0.08)`,g=p.getPropertyValue(`--text-muted`).trim()||`#7a7a7a`;n.fillStyle=m,n.fillRect(0,0,s,l);let v=0,y=_.filter(e=>o.has(e.notation));y.forEach(e=>{for(let t=1;t<=i;t++){let n=e.calc(t);n>v&&n<1/0&&(v=n)}}),v=Math.min(v*1.15,1e10),n.strokeStyle=h,n.lineWidth=1;for(let e=0;e<=5;e++){let t=u.top+f/5*e;n.beginPath(),n.moveTo(u.left,t),n.lineTo(s-u.right,t),n.stroke(),n.fillStyle=g,n.font=`11px JetBrains Mono, monospace`,n.textAlign=`right`,n.fillText(b(v*(1-e/5)),u.left-8,t+4)}let x=Math.min(i,10);for(let e=0;e<=x;e++){let t=u.left+d/x*e;n.beginPath(),n.moveTo(t,u.top),n.lineTo(t,l-u.bottom),n.stroke(),n.textAlign=`center`,n.fillText(Math.round(i/x*e).toString(),t,l-u.bottom+18)}n.fillStyle=g,n.font=`12px Inter, sans-serif`,n.textAlign=`center`,n.fillText(`Input Size (n)`,s/2,l-8),n.save(),n.translate(14,l/2),n.rotate(-Math.PI/2),n.fillText(`Operations`,0,0),n.restore(),y.forEach(e=>{let t=c===null||c===e.notation;n.beginPath(),n.strokeStyle=e.color,n.lineWidth=t?2.5:1.5,n.globalAlpha=t?1:.25;for(let t=1;t<=i;t++){let r=u.left+t/i*d,a=Math.min(e.calc(t),v),o=u.top+f-a/v*f;t===1?n.moveTo(r,o):n.lineTo(r,o)}if(n.stroke(),t){let t=Math.min(e.calc(i),v),r=u.top+f-t/v*f;n.fillStyle=e.color,n.font=`600 11px JetBrains Mono, monospace`,n.textAlign=`left`,n.fillText(e.notation,s-u.right+6,r+4)}n.globalAlpha=1})},[i,o,c]);(0,g.useEffect)(()=>(v(),window.addEventListener(`resize`,v),()=>window.removeEventListener(`resize`,v)),[v]),(0,g.useEffect)(()=>{if(!f){r.current&&=(clearTimeout(r.current),null);return}let e=0,t=()=>{e=e>=50?0:e+.5,a(Math.round(e)),r.current=window.setTimeout(t,50)};return r.current=window.setTimeout(t,0),()=>{r.current&&=(clearTimeout(r.current),null)}},[f]);let y=()=>p(e=>!e),x=t=>{let n=e.current;if(!n)return;let r=n.getBoundingClientRect(),a=t.clientX-r.left,s={left:55,right:70},c=r.width-s.left-s.right;if(a>=s.left&&a<=r.width-s.right){h(a);let e=Math.round((a-s.left)/c*i);if(e>=1){let n=_.filter(e=>o.has(e.notation)).map(t=>({notation:t.notation,color:t.color,value:b(t.calc(e))}));d({visible:!0,x:t.clientX+12,y:t.clientY-8,content:n,n:e})}}else h(null),d(e=>({...e,visible:!1}))},C=()=>{h(null),d(e=>({...e,visible:!1}))},w=e=>{s(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n})};return(0,S.jsxs)(`div`,{className:`interactive-chart-section`,children:[(0,S.jsxs)(`div`,{className:`chart-layout`,children:[(0,S.jsxs)(`div`,{className:`chart-card-container`,children:[(0,S.jsxs)(`div`,{className:`chart-card-header`,children:[(0,S.jsx)(`span`,{className:`chart-card-title`,children:`Growth Rate Comparison`}),(0,S.jsxs)(`div`,{className:`chart-controls`,children:[(0,S.jsxs)(`div`,{className:`chart-slider-group`,children:[(0,S.jsx)(`label`,{children:`n =`}),(0,S.jsx)(`input`,{type:`range`,min:1,max:50,value:i,onChange:e=>a(parseInt(e.target.value)),className:`chart-slider`}),(0,S.jsx)(`span`,{className:`chart-slider-value`,children:i})]}),(0,S.jsxs)(`button`,{className:`chart-play-btn ${f?`playing`:``}`,onClick:y,children:[f?(0,S.jsxs)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`currentColor`,children:[(0,S.jsx)(`rect`,{x:`6`,y:`4`,width:`4`,height:`16`}),(0,S.jsx)(`rect`,{x:`14`,y:`4`,width:`4`,height:`16`})]}):(0,S.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 24 24`,fill:`currentColor`,children:(0,S.jsx)(`polygon`,{points:`5 3 19 12 5 21 5 3`})}),(0,S.jsx)(`span`,{children:f?`Pause`:`Animate`})]})]})]}),(0,S.jsx)(`div`,{className:`chart-body`,children:(0,S.jsxs)(`div`,{className:`chart-wrapper`,ref:t,children:[(0,S.jsx)(`canvas`,{ref:e,onMouseMove:x,onMouseLeave:C}),m!==null&&(0,S.jsx)(`div`,{ref:n,className:`chart-crosshair`,style:{left:m}})]})}),(0,S.jsx)(`div`,{className:`chart-legend`,children:_.map(e=>(0,S.jsxs)(`button`,{className:`chart-legend-item ${o.has(e.notation)?``:`hidden`}`,onClick:()=>w(e.notation),children:[(0,S.jsx)(`span`,{className:`chart-legend-dot`,style:{background:e.color}}),e.notation]},e.notation))})]}),(0,S.jsx)(`div`,{className:`complexity-cards-sidebar`,children:_.map((e,t)=>(0,S.jsxs)(`button`,{className:`sidebar-complexity-card ${c===e.notation?`active`:``}`,style:{"--card-color":e.color,"--delay":`${t*.05}s`},onClick:()=>l(c===e.notation?null:e.notation),children:[(0,S.jsxs)(`div`,{className:`sidebar-card-row`,children:[(0,S.jsx)(`span`,{className:`sidebar-card-notation`,children:e.notation}),(0,S.jsx)(`span`,{className:`sidebar-card-badge sidebar-badge-${e.rating.toLowerCase()}`,children:e.rating})]}),(0,S.jsx)(`div`,{className:`sidebar-card-name`,children:e.name}),(0,S.jsxs)(`div`,{className:`sidebar-card-stats`,children:[(0,S.jsxs)(`span`,{children:[`n = `,i]}),(0,S.jsxs)(`span`,{className:`sidebar-card-ops`,children:[b(e.calc(i)),` ops`]})]})]},e.notation))})]}),u.visible&&(0,S.jsxs)(`div`,{className:`chart-tooltip`,style:{left:u.x,top:u.y},children:[(0,S.jsxs)(`strong`,{children:[`n = `,u.n]}),u.content.map(e=>(0,S.jsxs)(`div`,{style:{color:e.color},children:[e.notation,`: `,e.value]},e.notation))]})]})}function w({value:e}){return(0,S.jsx)(`td`,{className:`complexity-cell complexity-${x(e)}`,children:(0,S.jsx)(`span`,{className:`complexity-value`,children:e})})}function T(){return(0,S.jsxs)(`div`,{className:`complexity-table-container`,children:[(0,S.jsx)(`h3`,{className:`complexity-table-title`,children:`Data Structure Operations`}),(0,S.jsx)(`div`,{className:`complexity-table-wrapper`,children:(0,S.jsxs)(`table`,{className:`complexity-table`,children:[(0,S.jsxs)(`thead`,{children:[(0,S.jsxs)(`tr`,{children:[(0,S.jsx)(`th`,{rowSpan:2,className:`th-structure`,children:`Data Structure`}),(0,S.jsx)(`th`,{colSpan:4,className:`th-group`,children:`Time Complexity — Average`}),(0,S.jsx)(`th`,{colSpan:4,className:`th-group`,children:`Time Complexity — Worst`}),(0,S.jsx)(`th`,{rowSpan:2,className:`th-space`,children:`Space`})]}),(0,S.jsxs)(`tr`,{children:[(0,S.jsx)(`th`,{children:`Access`}),(0,S.jsx)(`th`,{children:`Search`}),(0,S.jsx)(`th`,{children:`Insertion`}),(0,S.jsx)(`th`,{children:`Deletion`}),(0,S.jsx)(`th`,{children:`Access`}),(0,S.jsx)(`th`,{children:`Search`}),(0,S.jsx)(`th`,{children:`Insertion`}),(0,S.jsx)(`th`,{children:`Deletion`})]})]}),(0,S.jsx)(`tbody`,{children:v.map(e=>(0,S.jsxs)(`tr`,{children:[(0,S.jsx)(`td`,{className:`td-structure`,children:e.name}),(0,S.jsx)(w,{value:e.avgAccess}),(0,S.jsx)(w,{value:e.avgSearch}),(0,S.jsx)(w,{value:e.avgInsert}),(0,S.jsx)(w,{value:e.avgDelete}),(0,S.jsx)(w,{value:e.worstAccess}),(0,S.jsx)(w,{value:e.worstSearch}),(0,S.jsx)(w,{value:e.worstInsert}),(0,S.jsx)(w,{value:e.worstDelete}),(0,S.jsx)(w,{value:e.space})]},e.name))})]})})]})}function E(){return(0,S.jsxs)(`div`,{className:`complexity-table-container`,children:[(0,S.jsx)(`h3`,{className:`complexity-table-title`,children:`Array Sorting Algorithms`}),(0,S.jsx)(`div`,{className:`complexity-table-wrapper`,children:(0,S.jsxs)(`table`,{className:`complexity-table sorting-table`,children:[(0,S.jsxs)(`thead`,{children:[(0,S.jsxs)(`tr`,{children:[(0,S.jsx)(`th`,{className:`th-structure`,children:`Algorithm`}),(0,S.jsx)(`th`,{colSpan:3,className:`th-group`,children:`Time Complexity`}),(0,S.jsx)(`th`,{className:`th-space`,children:`Space`})]}),(0,S.jsxs)(`tr`,{children:[(0,S.jsx)(`th`,{}),(0,S.jsx)(`th`,{children:`Best`}),(0,S.jsx)(`th`,{children:`Average`}),(0,S.jsx)(`th`,{children:`Worst`}),(0,S.jsx)(`th`,{})]})]}),(0,S.jsx)(`tbody`,{children:y.map(e=>(0,S.jsxs)(`tr`,{children:[(0,S.jsx)(`td`,{className:`td-structure`,children:e.name}),(0,S.jsx)(w,{value:e.best}),(0,S.jsx)(w,{value:e.avg}),(0,S.jsx)(w,{value:e.worst}),(0,S.jsx)(w,{value:e.space})]},e.name))})]})})]})}function D(){return(0,S.jsxs)(`div`,{className:`complexity-legend`,children:[(0,S.jsxs)(`div`,{className:`complexity-legend-item`,children:[(0,S.jsx)(`span`,{className:`complexity-legend-dot complexity-excellent`}),(0,S.jsx)(`span`,{children:`O(1) — Excellent`})]}),(0,S.jsxs)(`div`,{className:`complexity-legend-item`,children:[(0,S.jsx)(`span`,{className:`complexity-legend-dot complexity-good`}),(0,S.jsx)(`span`,{children:`O(log n) — Good`})]}),(0,S.jsxs)(`div`,{className:`complexity-legend-item`,children:[(0,S.jsx)(`span`,{className:`complexity-legend-dot complexity-fair`}),(0,S.jsx)(`span`,{children:`O(n) — Fair`})]}),(0,S.jsxs)(`div`,{className:`complexity-legend-item`,children:[(0,S.jsx)(`span`,{className:`complexity-legend-dot complexity-bad`}),(0,S.jsx)(`span`,{children:`O(n log n) — Bad`})]}),(0,S.jsxs)(`div`,{className:`complexity-legend-item`,children:[(0,S.jsx)(`span`,{className:`complexity-legend-dot complexity-horrible`}),(0,S.jsx)(`span`,{children:`O(n²), O(2ⁿ) — Horrible`})]})]})}var O=`Big O notation describes how an algorithm's runtime or space requirements grow as input size increases. It focuses on the worst-case growth rate, ignoring constants and lower-order terms.
...
Space Complexity: Memory matters too. Recursion uses O(depth) stack space. Creating new arrays costs O(n). In-place algorithms use O(1) extra space.`;function k(){return(0,S.jsxs)(S.Fragment,{children:[(0,S.jsx)(e,{badge:`O(n)`,badgeColor:`var(--accent-bigo)`,title:`Big O Complexity`,description:`Time and space complexity analysis. Master Big O to evaluate algorithm efficiency and optimize your code for large datasets.`}),(0,S.jsx)(i,{intro:O}),(0,S.jsx)(C,{}),(0,S.jsx)(D,{}),(0,S.jsx)(T,{}),(0,S.jsx)(E,{}),(0,S.jsx)(r,{methods:h,sections:o(h)}),(0,S.jsx)(a,{})]})}export{k as BigOPage};