...
import { stringMethods } from '../data/stringMethods'
import { intMethods } from '../data/intMethods'
import { floatMethods } from '../data/floatMethods'
import { boolMethods } from '../data/boolMethods'
import { listMethods } from '../data/list'
import { tupleMethods } from '../data/tupleMethods'
import { dictMethods } from '../data/dictMethods'
